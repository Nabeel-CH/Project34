...
wavelet-scattering spatial map, rather than enriching a scalar descriptor,
...
on the mass task while showing precisely why that claim does not transfer to our
tissue pipeline.

The paper's headline mass fusion result rests on a single ${\sim}22$-patch split; our
cross-validation reproduces its ${\approx}98\%$, but the honest repeated held-out estimate is
...
best \emph{number} while the region-aware representation is the substantive result.
